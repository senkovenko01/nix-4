...
public class BookServiceTest {
    ...
    public void createBook() {
        ...
        book = bookService.findBookByName(name);
    ...
    public void readBookById() {
        int bookId = bookService.findBookByName(name).getId();

        Book book = bookService.read(bookId);

        Assertions.assertEquals(name, book.getName());
    }
    ...
    public void readBooksByAuthor(){
        ...
        books.add(bookService.findBookByName(name));

        Assertions.assertNotNull(bookService.findBooksByAuthor(authorId));
        Assertions.assertEquals(books, bookService.findBooksByAuthor(authorId) );
    }
    ...
    public void updateBook() {
        ...
        String updName = bookInDB.getName() + " updated";
        bookInDB.setName(updName);
        bookService.update(bookInDB);

        bookInDB = bookService.read(bookId);

        Assertions.assertEquals(updName, bookInDB.getName());
    }
    ...
    public void deleteBook(){
        ...
        Book bookInDB = bookService.findBookByName(name);
        bookService.delete(bookInDB.getId());

        Book bookDeleted = bookService.findBookByName(name);
